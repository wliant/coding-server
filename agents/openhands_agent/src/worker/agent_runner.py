...
try:
    from openhands_agent import OpenHandsAgent, OpenHandsAgentConfig
except ImportError:  # pragma: no cover
    OpenHandsAgent = None  # type: ignore[assignment, misc]
    OpenHandsAgentConfig = None  # type: ignore[assignment, misc]
...
def _resolve_agent_classes():
    """Return (OpenHandsAgent, OpenHandsAgentConfig), retrying import if needed."""
    global OpenHandsAgent, OpenHandsAgentConfig  # noqa: PLW0603
    if OpenHandsAgent is not None and OpenHandsAgentConfig is not None:
        return OpenHandsAgent, OpenHandsAgentConfig
    from openhands_agent import OpenHandsAgent as _OHA, OpenHandsAgentConfig as _OHAC
    OpenHandsAgent = _OHA  # type: ignore[assignment]
    OpenHandsAgentConfig = _OHAC  # type: ignore[assignment]
    return OpenHandsAgent, OpenHandsAgentConfig
...
async def run_coding_agent(
    ...
    try:
        ...
        error_msg = f"Failed to import openhands_agent: {tb}"
